...
\begin{proposicao}\label{subgrupo_contido_propriamente_no_normalizador}
...
\end{lema}
\begin{prova}
	Seja $H \le G$. Defina $H_0 = H$ e indutivamente $H_n = N_G(H_{n - 1})$. Da Proposi\c{c}\~ao \ref{subgrupo_contido_propriamente_no_normalizador} segue que se $H_{n - 1} \ne G$, ent\~ao $|H_{n - 1}| < |H_n|$. Como $G$ \'e finito, existe $i$ tal que $H_i = G$. Assim a cadeia
	\[
