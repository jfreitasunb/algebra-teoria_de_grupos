...
\begin{prova}
	\begin{enumerate}
		...
		\item Pela parte (b), existe $\sigma \in S_n$ tal que $\beta = \sigma\rho\sigma^{-1}$. Usando as mesmas nota\c{c}\~oes de (b), como $\rho$ fixa pelo menos duas letras, ent\~ao $k \ge 2$. Tome ent\~ao
		\[
