...
\begin{teorema}[Teorema dos Isomorfismos]\label{teorema_isomorfismo}
...
\begin{prova}
	...
	\begin{align*}
		...
		h \mapsto \phi(h).
	\end{align*}
	\'E imediato verificar que $\psi(K) = \phi(K)$ e que $\ker\psi = \ker\phi$. Logo pelo Teorema dos Isomorfismos, Teorema \ref{teorema_isomorfismo}, temos $K/\ker\psi \cong \psi(K)$, isto \'e,
	\[
...
\end{corolario}
\begin{prova}
	\'E f\'acil verificar que $\phi : G \to G/H$ dada por $\phi(a) = aH$ \'e um homomorfismo sobrejetivo. Aplicando a segunda parte do Teorema dos Isomorfismos, Teorema \ref{teorema_isomorfismo}, obtemos o resultado.
\end{prova}
