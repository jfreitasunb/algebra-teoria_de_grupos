...
\end{align}
s\~ao chamadas de \textbf{s\'erie central superior (ou ascendente)} e \textbf{s\'erie central inferior (ou descendente)} de $G$, respectivamente. Claramente estas s\'eries s\~ao centrais, \'E imediato verificar que $\gamma_i(G)$ \'e caracter{\'\i}stico em $G$ para todo $i$.
