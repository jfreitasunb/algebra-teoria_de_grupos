...
As sequ\^encias
\begin{align}
	\{1\} = Z_0(G) \sub Z_1(G) \sub Z_2(G) \sub \cdots \sub Z_n(G) \sub \cdots\\
	G = \gamma_1(G) \supseteq \gamma_2(G) \supseteq \gamma_3(G) \supseteq \cdots \supseteq \gamma_n(G) \supseteq \cdots
\end{align}
