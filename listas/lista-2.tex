...
\questao Sejam $p$ um número primo e $n \in \N$. Mostre que:
\begin{enumerate}
  \item Todo elemento de ordem $p$ no grupo $S_p$ é um p-ciclo.
  \item $S_p$ não tem elemento de ordem $kp$ com $k \ge 2$.
  \item Se $t$ é um inteiro positivo, mostre que o grupo $S_n$ possui elementos de ordem $p^t$ se, e somente se, $n \ge p^t$.
\end{enumerate}
