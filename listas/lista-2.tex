...
\questao Seja $Q_8 = \{\pm 1, \pm i, \pm j, \pm k\}$, onde $i^2 = j^2 = k^2 = -1$ e $ij = k$, $jk = i$, $ki = j$, $ji = -k$, $kj = -i$, $ik = -j$. Mostre que $Q_8$ é um grupo e que $Q_8 \cong \mathcal{Q}$, onde
\[
...
\questao Calcule todos os subgrupos grupos dados. Quais são normais?
